...
=== logging standards
Clarified and enhanced logging standards, including:
- Logger naming and configuration
- String substitution patterns
- Test coverage requirements
- Clear distinction between production and test logging

See link:doc/llm-rules/logging.md[rules].
